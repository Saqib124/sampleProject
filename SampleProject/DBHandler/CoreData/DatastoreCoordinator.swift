...
//  TestProject
//
//  Created by Saqib Khan on 3/25/18.
...
class DatastoreCoordinator: NSObject {
    ...
    fileprivate let objectModelName = "SampleProject"
    fileprivate let objectModelExtension = "momd"
    fileprivate let dbFilename = "SampleProject.sqlite"
    fileprivate let appDomain = "com.test.project.TestProject"
